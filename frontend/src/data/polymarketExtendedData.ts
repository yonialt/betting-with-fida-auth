...
export const HERO_CAROUSEL_SLIDES: HeroSlideItem[] = [
  // Slide 0: Fed Decision in September?
  {
    ...
    commentsTicker: [
      { user: 'JohnA', text: 'No matter the result, its an honor to gamble with you fellow degens', amount: '+$5', positive: true },
      { user: 'TheAllKnowingSeer', text: 'We shall win.', amount: '+$1', positive: true },
      { user: 'JeanneDelETH', text: 'Foolproof across the casino, thats the intended way, amex', amount: '+$133', positive: true },
      { user: 'MarketMaker99', text: 'Rate cuts locked in for late September cycle', amount: '+$112', positive: true },
    ],
  },
  // Slide 1: Clarity Act (H.R.3633) signed into law in 2026?
  {
    ...
    commentsTicker: [
      { user: 'returnMySollo', text: 'Clarity Act signed July', amount: '+$112', positive: true },
      { user: 'State-Asphalt', text: 'Nope. Will never get enough Democrat votes now that they started slush fund for Jan 6 rioters and...', amount: '+$100', positive: true },
      { user: 'SenatorPalpatine', text: 'Then why did you buy 10 shares?', amount: '+$250', positive: true },
      { user: 'Nigel364', text: 'crypto bill has strong bipartisan momentum in committee', amount: '+$90', positive: true },
    ],
  },
  // Slide 2: Bitcoin Up or Down
  {
    ...
    commentsTicker: [
      { user: 'skibidi-dbidi', text: 'bop', amount: '+$8', positive: true },
      { user: 'wsggng', text: 'Actually true', amount: '+$1', positive: true },
      { user: 'Noted-Purchase', text: 'Perp is healthier than everything.', amount: '+$2', positive: true },
      { user: 'ghochu', text: 'you can like only one comment a time', amount: '+$7', positive: true },
    ],
  },
  // Slide 3: Balance of Power: 2026 Midterms
  {
    ...
    commentsTicker: [
      { user: 'AP News', text: 'Midterm mail ballots start to go to voters as litigation over Trump order creates uncertainty', amount: '+$14', positive: true },
      { user: 'Bloomberg', text: 'Trump Seeks to Move Case to Conviction for Midterms', amount: '+$8', positive: true },
      { user: 'Constitutionalist', text: 'Senate map is razor thin across 4 key swing states', amount: '+$3', positive: true },
    ],
  },
  // Slide 4: Which company has the best AI model end of September?
  {
    ...
    commentsTicker: [
      { user: 'pooperman', text: 'If you actually used LMArena, Grok will say its an outdated model. Congrats, you played yourself.', amount: '+$50', positive: true },
      { user: 'DYING-IN-XXTYLE-PART...', text: '-50% on your position lol', amount: '+$8', positive: true },
      { user: 'BoneWong', text: 'Sonnet 3.5 update is unbeatable on coding benchmarks', amount: '+$350', positive: true },
      { user: 'DeepMindEnthusiast', text: 'Gemini Flash 2.0 release could shake up the leaderboard', amount: '+$17', positive: true },
    ],
  },
  // Slide 5: CS2 Spirit vs MOUZ
  {
    ...
    commentsTicker: [
      { user: 'DonkCS', text: 'Donk with 1.45 rating on Mirage is unfair', amount: '+$210', positive: true },
      { user: 'siuhyFan', text: 'MOUZ force buy comeback incoming on map 4', amount: '+$40', positive: true },
    ],
  },
  // Slide 6: Brewers vs Reds
  {
    ...
    commentsTicker: [
      { user: 'EllyDeLaCruz', text: 'Bases loaded 2 outs in bottom of the 5th', amount: '+$85', positive: true },
      { user: 'BrewCrew99', text: 'Bullpen warming up, still have 4 innings', amount: '+$12', positive: true },
    ],
  },
  // Slide 7: Will China invade Taiwan by end of 2026?
  {
    ...
    commentsTicker: [
      { user: 'TaipeiTrader', text: 'Status quo remains overwhelming consensus for now', amount: '+$940', positive: true },
      { user: 'GeopoliticsDaily', text: 'Naval exercises in strait recorded routine volume', amount: '+$25', positive: true },
    ],
  },
];
...
export const PERP_TOKENS: PerpToken[] = [
  { symbol: 'PUMP', price: '$0.003852', change: '-$0.000180 (4.46%)', positive: false, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#10b981' },
  { symbol: 'ZEC', price: '$1,213.3', change: '+$170.19 (17.39%)', positive: true, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#f59e0b' },
  { symbol: 'FARTCOIN', price: '$0.18298', change: '-$0.015213 (7.10%)', positive: false, volume: '$2M Vol.', isLive: true, category: 'Crypto', logoBg: '#8b5cf6' },
  { symbol: 'KSHIB', price: '$0.005433', change: '-$0.000109 (1.71%)', positive: false, volume: '$2M Vol.', isLive: true, category: 'Crypto', logoBg: '#ef4444' },
  { symbol: 'BTC', price: '$79,785', change: '+$174.00 (0.21%)', positive: true, volume: '$2M Vol.', isLive: true, category: 'Crypto', logoBg: '#f59e0b' },
  { symbol: 'ZRO', price: '$1.0956', change: '+$0.0303 (2.84%)', positive: true, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#3b82f6' },
  { symbol: 'SOL', price: '$106.41', change: '+$2.52 (2.43%)', positive: true, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#14b8a6' },
  { symbol: 'LIT', price: '$4.6786', change: '-$0.0919 (1.96%)', positive: false, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#6366f1' },
  { symbol: 'NEAR', price: '$2.3776', change: '+$0.1400 (6.26%)', positive: true, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#06b6d4' },
  { symbol: 'ETH', price: '$2,492.5', change: '+$14.50 (0.58%)', positive: true, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#627eea' },
  { symbol: 'HYPE', price: '$87.89', change: '+$2.374 (2.78%)', positive: true, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#ec4899' },
  { symbol: 'CRCL', price: '$104.04', change: '+$2.29 (2.25%)', positive: true, volume: '$1M Vol.', isLive: true, category: 'Crypto', logoBg: '#38bdf8' },
  { symbol: 'MSTR', price: '$143.81', change: '+$0.12 (0.08%)', positive: true, volume: '$961K Vol.', isLive: true, category: 'Stocks', logoBg: '#dc2626' },
  { symbol: 'COIN', price: '$185.74', change: '-$0.16 (0.08%)', positive: false, volume: '$888K Vol.', isLive: true, category: 'Stocks', logoBg: '#0284c7' },
  { symbol: 'DOGE', price: '$0.089112', change: '-$0.000349 (0.39%)', positive: false, volume: '$800K Vol.', isLive: true, category: 'Crypto', logoBg: '#eab308' },
  { symbol: 'TAO', price: '$259.21', change: '+$24.72 (10.54%)', positive: true, volume: '$771K Vol.', isLive: true, category: 'Crypto', logoBg: '#10b981' },
  { symbol: 'SUI', price: '$0.79772', change: '+$0.06126 (7.68%)', positive: true, volume: '$768K Vol.', isLive: true, category: 'Crypto', logoBg: '#0ea5e9' },
  { symbol: 'ADA', price: '$0.21886', change: '-$0.00248 (1.12%)', positive: false, volume: '$677K Vol.', isLive: true, category: 'Crypto', logoBg: '#2563eb' },
  { symbol: 'AMD', price: '$479.36', change: '+$2.50 (0.52%)', positive: true, volume: '$671K Vol.', isLive: true, category: 'Stocks', logoBg: '#b91c1c' },
  { symbol: 'GOLD', price: '$4,430.8', change: '-$7.10 (0.16%)', positive: false, volume: '$651K Vol.', isLive: true, category: 'Commodities', logoBg: '#fbbf24' },
  { symbol: 'ONDO', price: '$0.37825', change: '-$0.00980 (2.66%)', positive: false, volume: '$604K Vol.', isLive: true, category: 'Crypto', logoBg: '#475569' },
  { symbol: 'SKHY', price: '$176.35', change: '-$0.45 (0.26%)', positive: false, volume: '$601K Vol.', isLive: true, category: 'Stocks', logoBg: '#059669' },
  { symbol: 'BNB', price: '$747.98', change: '+$29.80 (4.04%)', positive: true, volume: '$587K Vol.', isLive: true, category: 'Crypto', logoBg: '#f59e0b' },
  { symbol: 'UNI', price: '$7.1896', change: '+$0.2665 (3.71%)', positive: true, volume: '$565K Vol.', isLive: true, category: 'Crypto', logoBg: '#ff007a' },
];
...
export const MENTION_EVENTS: MentionEvent[] = [
  {
    ...
    day: '4',
    month: 'Sep',
    timeInfo: 'Fri, 11:00 PM · LIVE $4,244 Vol.',
  ...
  },
  {
    ...
    day: '6',
    month: 'Sep',
    timeInfo: 'Sun, 11:00 PM · $12,343 Vol.',
...
export const ART_MARKETS: ArtMarketCard[] = [
  ...
  {
    id: 'art-market-65b',
    title: 'Will global art market sales hit $65 billion for 2026?',
    chance: '12% chance',
    volume: '$18K Vol.',
    partnerBadge: 'Asked by Masterworks',
  },
  {
    ...
    title: 'AI artwork hits $10M at major auction in 2026?',
    chance: '13% chance',
    volume: '$13K Vol.',
    partnerBadge: 'Asked by Masterworks',
  },
  ...
  },
  {
    ...
    volume: '$35K Vol. · Asked by Masterworks',
    partnerBadge: 'Asked by Masterworks',
    options: [
  ...
  {
    id: 'art-sell-150m',
    title: 'Will an artwork sell for $150 million by December 31?',
    chance: '54% chance',
    volume: '$18K Vol.',
    partnerBadge: 'Asked by Masterworks',
  },
...
export const ART_FAQS = [
  ...
  },
  {
    ...
    a: 'Each share pays out $1.00 if the event occurs, or $0.00 if it does not. The price in cents directly reflects the collective probability (e.g. 54¢ = 54% chance).',
  },
  {
    q: 'Which Art markets are most active right now?',
    a: 'Currently, the Masterworks-sponsored Turner Prize 2026, Banksy street artwork verification, and the $150M single-lot auction milestone are drawing top volume.',
  },
];
