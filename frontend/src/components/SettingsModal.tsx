...
export const SettingsModal: React.FC = () => {
  ...
  // Built from the app's real origin (hagerawi.click in production) so the
  // shared link always lands on the live site.
  const referralCode =
  ...
  const siteOrigin =
    typeof window !== 'undefined' && window.location
      ...
      : 'https://hagerawi.click';
  const referralLink = `${siteOrigin}/join?ref=${referralCode}`;
