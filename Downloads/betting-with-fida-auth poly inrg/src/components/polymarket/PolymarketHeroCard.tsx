          ...
          <div className="mt-4">
            {slide.id === 'clarity-act' ? (
              <div className="flex items-center gap-3">
                ...
                >
                  <span>Yes 16¢</span>
                  <span className="text-xs text-emerald-300 font-normal">16% chance</span>
                </button>
                <button
                  onClick={() =>
                    onSelectOutcome({
                ...
                >
                  <span>No 84¢</span>
                  <span className="text-xs text-red-300 font-normal">84% chance</span>
                </button>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1 p-3 rounded-xl bg-[#141b27] border border-[#222d3d] flex items-center justify-between">
                  <div>
                    <div className="text-[11px] text-neutral-400">Price to Beat</div>
                    <div className="font-mono font-bold text-white text-base">
                      ${slide.priceToBeat?.toLocaleString()}
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-[11px] text-neutral-400">Current Price</div>
      ...
      <div className="flex items-center justify-between gap-3 mt-4 mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {slide.prevSlideLabel && (
            ...
            >
              <span>{slide.prevSlideLabel}</span>
            </button>
          )}
          ...
          {slide.nextSlideLabel && (
            <button
              ...
              className="px-3.5 py-1.5 rounded-full bg-[#141a26] hover:bg-[#1d2636] border border-[#222b3b] text-neutral-300 text-xs font-semibold flex items-center gap-1 cursor-pointer transition-colors"
            >
              <span>{slide.nextSlideLabel}</span>
